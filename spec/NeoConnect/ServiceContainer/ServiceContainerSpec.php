...
class ServiceContainerSpec extends NeoBaseSpec
{
    ...
    function it_should_have_a_container_builder_by_default()
    {
        $this->getServiceContainer()->shouldHaveType('Symfony\Component\DependencyInjection\ContainerBuilder');
    }

    function it_should_not_have_a_processed_config_by_default()
    {
        $this->getProcessedConfig()->shouldBeNull();
    }

    function it_should_ask_the_validator_to_validate_the_provided_configuration()
    {
    ...
    function it_should_have_a_processed_config_after_validation()
    {
        $config = $this->createConfig();
    ...
    function it_should_build_the_container_in_two_steps()
    {
        $this->loadConfiguration($this->createConfig());
    ...
    function it_should_have_an_event_dispatcher_in_service_definitions()
    {
        $this->loadConfiguration($this->createConfig());
        $this->build();
    ...
    function it_should_have_a_shortcut_for_the_connection_manager()
    {
        $this->loadConfiguration($this->createConfig());
        $this->build();
    ...
    function it_should_register_connections_based_on_processed_configs()
    {
        $this->loadConfiguration($this->createConfig());
        $this->build();
