...
class ValidatorSpec extends NeoBaseSpec
{
    ...
    function it_should_have_a_definition_by_default()
    {
        $this->getDefinition()->shouldHaveType('NeoConnect\Config\Definition');
    }

    function it_should_have_a_config_loader_by_default()
    {
        $this->getLoader()->shouldHaveType('NeoConnect\Config\Loader');
    }

    function it_should_validate_loaded_config_against_definition()
    {
